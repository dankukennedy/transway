...
<div class="sdashboard">
        ...
        <div class="main-content">
            ...
            <?php  include('../includes/psms.php'); ?>
                ...
                <?php
                    ...
                    $totalRecords = $dataRequest-> newApplicationServe(); // Method to get total count
                    $result = $dataRequest->getPaginatedApplications1($recordsPerPage, $offset); // Get records for current page
    ...
    <tbody>
        ...
        $result = $request->totalFetchTransReady();
        if($result)
        {
